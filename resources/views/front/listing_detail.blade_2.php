...
<img src="{{ asset('images/aprovacao.jpg') }}" class="img-responsive" />
</div>
</div>
</div>
</div>
                                ...
                                <div class="swiper-slide">                                     
                                    ...
                                    @if($rowPhotos->canal == 'dsautoestoque')                                       
                                        ...
                                        @else
                                            ...
                                            <img src="{{ $rowPhotos->photo }}" alt="" style="width: 100%; height: auto;">
                                            </a>
                                        @endif                                        
            ...
            @else
                @if ($detail->listing_image_alterada_admin == 1)
                    <a href="{{ asset('uploads/listing_featured_photos/' . $detail->listing_featured_photo) }}" data-fancybox="gallery" class="magnific">
                                            <img src="{{ asset('uploads/listing_featured_photos/' . $detail->listing_featured_photo) }}" alt="" style="width: 100%; height: auto;">
                                            </a>
                @else
                   <a href="{{ $detail->listing_featured_photo }}" data-fancybox="gallery" class="magnific">
                                                <img src="{{ $detail->listing_featured_photo }}" alt="" style="width: 100%; height: auto;">
                                                </a>
                @endif
            @endif
...
@endif   
	...
	<div class="container">             
		<div class="row">
         ...
         <img src="{{ asset('images/logo-itau.png') }}" style="width:22px;margin-right:3px;">simular parcelas
    </a>                                                                                                      
      ...
      {!! clean($detail->listing_description) !!}
					...
					<div class="contact" style="border-radius: 8px;padding: 10px; box-shadow: 3px 3px 5px rgba(0, 0, 0, 0.3);">
						...
						<div class="clearfix clear"></div>
                                                ...
                                                <form action="?action=simular" method="post" id="financiamentoForm" class="form-simulador formulario-simulador-modal mt-4 pl-2 form-contato">  
                        <div class="row">
                            <div class="col-md-6 form-floating mb-3">  
                                <label for="nomeCompleto-modal">Nome Completo <span class="badge badge-danger">*</span></label>
                                <input type="text" name="nomeCompleto" id="nomeCompleto-modal" class="form-custom nomeCompleto-modal" placeholder="Nome completo*" required="true">
                                                            </div>
                            <div class="col-md-6 form-floating mb-3">
                                <label for="email_simulador-modal">E-mail <span class="badge badge-danger">*</span></label>
                                <input type="email" id="email_simulador-modal" name="email_simulador" class="form-custom email_simulador-modal" placeholder="E-mail*" required="true">
                                                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 form-floating mb-3">
                                <label for="cpf_simulador-modal">CPF <span class="badge badge-danger">*</span></label>
                                <input type="tel" id="cpf_simulador-modal" name="cpf_simulador" min="11" max="11" maxlength="11" class="form-custom cpf_simulador-modal cpf" placeholder="CPF*" required="true">
                               </div>
                            <div class="col-md-6 form-floating mb-3">
                                <label for="telefone_simulador-modal">Celular <span class="badge badge-danger">*</span></label>
                                <input type="tel" id="telefone_simulador-modal" name="telefone_simulador" min="11" max="11" maxlength="11" class="form-custom telefone_simulador-modal celular" placeholder="Celular*" required="true">
                                                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-12 mb-3">
                                <label for="autorizacao-modal">
                            ...
                            <div class="form-group col-md-12 mt-4 d-flex justify-content-between">
                                <button type="submit" class="btn btn-warning btn-flat btn-block btn-lg  ms-auto" 
                                        style="font-size: 18px;background-color: #ec7000;color: #fff;" id="btn-simular">simular financiamento agora</button>
                            </div>
                        </div> 
                    </form>
                                                <style>
...
.modal-backdrop {
    ...
    $(document).ready(function() {
        ...
        data: {
            ...
            name: nomeCompleto,
            mobile_phone: telefoneApenasNumeros,
        },
        success: function(response) {
            console.log(response.message);
        },
        error: function(error) {
            console.log('Erro ao enviar o lead.');
            console.log(error);
        }
    });
            ...
            $('#simulador-modal').modal('hide');
            $('#simulador-modal').addClass('show').css('display', 'block');
					...
					<div class="ls-widget" style=" box-shadow: 3px 3px 5px rgba(0, 0, 0, 0.3);padding:10px;">
						...
						<div class="agent-contact">
							<ul>
								...
								@endif
								@if($agent_detail_phone!='')                                                       
                                                                <li><a href="tel:{{ $agent_detail_phone }}"><i class="fas fa-phone-volume"></i> {{ $agent_detail_phone }}</a></li>
                                                                @endif
						...
						<a href="{{ route('front_listing_agent_detail',[$type,$agent_detail->id]) }}" class="btn btn-outline-dark btn-block">Ver estoque do vendedor</a>
					</div>
