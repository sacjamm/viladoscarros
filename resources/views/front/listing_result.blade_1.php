                        ...
                        <div class="lf-widget">
                            ...
                            <select name="listing_type" class="form-control" id="listing_type">
                                ...
                                @if (request()->has('listing_type'))
                                    <option {{ request()->get('listing_type') ==  'Novo' ? 'selected' : ''  }}  value="Novo" >{{ NEW_CAR }}</option>
								    <option {{ request()->get('listing_type') ==  'Usado' ? 'selected' : ''  }} value="Usado" >{{ USED_CAR }}</option>
                                @else
...
<script>
    ...
    function submitSearchForm(){
        ...
        var request = $('#searchFormId').serialize();
