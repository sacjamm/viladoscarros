...
<link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
        ...
        @endif
        @endif        
        <style>#brandspng{margin-top:40px}.mobile-nav.mean-container .mean-nav ul li a.active,.main-nav nav .navbar-nav .nav-item a:hover,.main-nav nav .navbar-nav .nav-item a:focus,.main-nav nav .navbar-nav .nav-item a.active,.main-nav nav .navbar-nav .nav-item:hover a,.main-nav nav .navbar-nav .nav-item .dropdown-menu li a:hover,.main-nav nav .navbar-nav .nav-item .dropdown-menu li a:focus,.main-nav nav .navbar-nav .nav-item .dropdown-menu li a.active,.main-nav nav .navbar-nav .nav-item .dropdown-menu li .dropdown-menu li a:hover,.main-nav nav .navbar-nav .nav-item .dropdown-menu li .dropdown-menu li a:focus,.main-nav nav .navbar-nav .nav-item .dropdown-menu li .dropdown-menu li a.active,.main-nav nav .navbar-nav .nav-item .dropdown-menu li:hover a,.main-nav nav .navbar-nav .nav-item .dropdown-menu li a:hover,.listing .listing-item .text .location,.listing .listing-item .text h3 a:hover,.footer-item h2,.footer-item ul li a:hover,.listing-filter .lf-heading,.listing .listing-item .text .location a,.listing-single-banner .listing-items a,.listing-page h2 i,.listing-page .amenities li i,.listing-page .contact a,.listing-page .review-overall .total,.listing-sidebar .ls-widget .agent-contact li,.listing-sidebar .ls-widget .agent-contact li a,.listing-sidebar .ls-widget .category ul li a,.faq h4.panel-title a,.sidebar .widget .type-1 ul li:before,.sidebar .widget .type-1 ul li a:hover,.contact-icon i,.reg-login-form .new-user a,.reg-login-form .link,.listing-page .room-all .item .price,.popular-city .popular-city-item:hover h4{color:#{{$g_setting->theme_color}}}.main-nav nav .navbar-nav .nav-item .dropdown-menu li a:hover,.mean-container a.meanmenu-reveal,.footer-social-link ul li a:hover{color:#ffffff!important}.search-section .input-group-append button,.listing .listing-item .photo .brand a,.popular-city-carousel .owl-nav .owl-prev,.popular-city-carousel .owl-nav .owl-next,.footer-social-link ul li a,.scroll-top,.page-banner,.filter-button,.listing-sidebar .ls-widget .agent-social ul li a,.listing-sidebar .ls-widget a.agent-view-profile,.pricing .btn,.contact-form .btn,.reg-login-form button,.listing .owl-nav .owl-prev,.listing .owl-nav .owl-next,.listing-single-banner .social a:hover,.top,.agent-banner .social a:hover,.mean-container a.meanmenu-reveal span,.comment button{background:#{{$g_setting->theme_color}}}.footer-social-link ul li a,.contact-form .btn{border-color:#{{$g_setting->theme_color}}}.listing-filter .lf-heading{border-bottom-color:#{{$g_setting->theme_color}}}.navbar-brand{padding-top:0;padding-bottom:0}#myTab .nav-link{padding:.2rem .3rem!important;font-size:.775rem!important}#stickymenuGeral{box-shadow:0 2px 10px rgb(0 0 0 / .3)!important}#stickymenu{width:100%;background-color:#000!important;box-shadow:0 0 10px rgb(255 255 255 / .3)!important}.stickymenu{position:fixed!important;top:0;width:100%;z-index:1000;background-color:#fff;box-shadow:0 2px 10px rgb(0 0 0 / .3)!important}.search-section{height:152px!important}#searchFormId{display:none}#btn-filter{display:inline}#span-filter{display:none}.form-check-input:checked+.form-check-label{transition:transform 0.3s,border-color 0.3s}.form-check-input-modelos:checked+.form-check-label-modelos{transition:transform 0.3s,border-color 0.3s}.brand-logo{transition:transform 0.3s!important}.form-check-input:checked+.form-check-label .brand-logo{border-color:#00d6a6!important}.form-check-input-modelos:checked+.form-check-label-modelos .brand-logo{border-color:#00d6a6!important}.form-check-label:hover{transform:scale(.9);transition:transform 0.3s,border-color 0.3s}.form-check-label-modelos:hover{transform:scale(.9);transition:transform 0.3s,border-color 0.3s}label.label-brand-check{-webkit-justify-content:center;justify-content:center;-webkit-box-shadow:0 4px 8px -4px rgb(0 0 0 / .3);box-shadow:0 4px 8px -4px rgb(0 0 0 / .3);text-align:center;cursor:pointer;border:1px solid #ccc;border-radius:5px;transition:border-color 0.3s;float:left}.form-check-radio-input{display:none}.form-check-radio-label{cursor:pointer}.btn-check:checked+.form-check-radio-label{background-color:#333;border-color:#333;color:#fff}.form-check-radio-label:hover{background-color:#333;border-color:#333}.two-columns{columns:3;-webkit-columns:3;-moz-columns:3;list-style:none;padding:0}.two-columns li{margin-bottom:10px;display:flex;align-items:center;font-size:14px!important}.two-columns li i{margin-right:5px;color:#000}.duas-colunas{columns:2;-webkit-columns:2;-moz-columns:2;list-style:none;padding:0}.duas-colunas li{margin-bottom:5px!important;display:flex;align-items:center}.duas-colunas li span{font-size:14px}.ulDetail li p span{font-size:14px!important}.ulDetail li p span.title_nome{font-size:12px!important}.duas-colunas li a{font-size:14px!important}.duas-colunas li i{margin-right:5px;color:#000}.btn-check{position:absolute;opacity:0;pointer-events:none}#barra_de_rolagem{overflow-y:auto;overflow-x:hidden;padding:5px;box-sizing:border-box}#barra_de_rolagem::-webkit-scrollbar{width:7px}#barra_de_rolagem::-webkit-scrollbar-track{background:#f1f1f1;border-radius:5px}#barra_de_rolagem::-webkit-scrollbar-thumb{background-color:#888;border-radius:5px}#barra_de_rolagem::-webkit-scrollbar-thumb:hover{background:#555}.form-contato .form-custom:focus{border:2px solid #000}.form-contato .form-custom{display:block;width:100%;height:calc(1.5em + .75rem + 2px);padding:.375rem .75rem;font-size:1rem;font-weight:400;line-height:1.5;color:#495057;background-color:#fff;background-clip:padding-box;border:2px solid #333;border-radius:.25rem;transition:border-color .15s ease-in-out,box-shadow .15s ease-in-out}.ldORxL{color:#ffffff!important;display:flex;-webkit-box-align:center;align-items:center;background:#2e2e37;padding:15px 14px 13px 14px;border-radius:8px 8px 0 0;font-weight:400!important}.ldORxL i{color:#ffffff!important;margin-right:5px}.e-font-icon-svg{height:100px}.elementor-icon i,.elementor-icon svg{width:1em;height:1em;position:relative;display:block}.elementor-icon{fill:#000;color:#000;border-color:#000;display:inline-block;line-height:1;transition:all .3s;color:#69727d;font-size:50px;text-align:center}.elementor-icon-box-icon{text-align:center!important}.elementor-icon-box-wrapper{min-height:300px}.page-content .table-bordered td,.table-bordered th{border:none!important}.page-content .table td,.table th{width:49%!important}.owl-nav{position:absolute;top:1%;width:100%;transform:translateY(-50%);display:flex;justify-content:space-between}.owl-nav .owl-prev,.owl-nav .owl-next{width:30px;height:30px;background-color:rgb(0 0 0 / .5);color:#fff;padding:2px .9%;border-radius:50%;cursor:pointer;font-size:18px}.owl-nav .owl-prev{left:-15px}.owl-nav .owl-next{right:-15px}.navbar-brand img{min-height:31px}@media (max-width:768px){.navbar-brand img,.mobile-nav img{min-height:20px}.owl-nav .owl-prev,.owl-nav .owl-next{padding:2.1px 2.7%}.select-filter-home{width:100%!important;min-width:100%!important}.ldORxL{padding:20px 14px 20px 14px}}@media (min-width:768px){#searchFormId{display:block}#btn-filter{display:none}#span-filter{display:block}.buttons-filter{display:none}}@media (max-width:991px){div#stickymenu>div.mobile-nav>a.logo>img{width:150px!important;height:auto!important}.select-filter-home{width:100%!important;min-width:100%!important}.search-section{height:342px!important}}@media (min-width:991px){#searchFormId{display:block}#btn-filter{display:none}#span-filter{display:block}.buttons-filter{display:none}}#brandspng.carousel-marcas .item form button{border:none!important}#brandspng.carousel-marcas .item form button img{margin:3px!important;padding:2px!important}.btn-follow{background-color:#c50f0f;color:#fff;border:1px solid #c50f0f}.btn-follow:hover{background-color:#580303fa;color:#e1e1e1;border:1px solid #580303fa}.banner-img{display:block;width:100%;height:68vh;object-fit:cover;max-height:800px}@media (min-width:1400px){.banner-img{height:70vh}}@media (max-width:991px){.banner-img{height:50vh}}@media (max-width:768px){.banner-img{height:40vh}}@media (max-width:480px){.banner-img{height:30vh}}.search-section{background-color:rgb(13 38 59 / .8);position:relative;left:50%;transform:translate(-50%,-16%);z-index:99;width:90%;border-radius:10px}@media (max-width:768px){.search-section{background-color:#0d263b;top:0;left:0;transform:none;width:100%;border-radius:0;margin-top:0}}@media (max-width:480px){#slideshow{margin-top:60px}.search-section{background-color:#0d263b;top:0;left:0;transform:none;width:100%;border-radius:0;margin-top:0}}</style>
