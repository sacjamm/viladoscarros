        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="listing_location_name" id="listing_location_name" class="form-control listing_location_name" value="{{ $listing_location->listing_location_name }}" autofocus oninput="generateSlug('listing_location_name','listing_location_slug')">
                </div>
                <div class="form-group">
                    <label for="">{{ SLUG }}</label>
                    <input type="text" name="listing_location_slug" id="listing_location_slug" class="form-control listing_location_slug" value="{{ $listing_location->listing_location_slug }}" readonly="">
                </div>
                <div class="form-group">
                    <label for="">{{ EXISTING_PHOTO }}</label>
                    <div>
                        <img src="{{ asset('uploads/listing_location_photos/'.$listing_location->listing_location_photo) }}" alt="" class="w_200">
                    </div>
                </div>
                <div class="form-group">
