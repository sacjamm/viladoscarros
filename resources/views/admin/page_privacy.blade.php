...
@section('admin_content')
    ...
    <form action="{{ route('admin_page_privacy_update') }}" method="post" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="current_banner" value="{{ $page_privacy->banner }}">
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="detail" class="form-control " id="summernote" cols="30" rows="10">{{ $page_privacy->detail }}</textarea>
                </div>
                <div class="form-group">
                    <label for="">{{ EXISTING_BANNER }}</label>
                    <div>
                        <img src="{{ asset('uploads/page_banners/'.$page_privacy->banner) }}" alt="" class="w_300">
                    </div>
                </div>
                <div class="form-group">
