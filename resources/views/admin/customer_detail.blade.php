            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    <div class="float-right d-inline">
                        <a href="{{ route('admin_customer_acessar',['id' => $customer_detail->id]) }}" target="_blank" class="btn btn-warning btn-sm">Área do lojista <i class="fa fa-external-link-alt"></i></a>
                        <a href="{{ route('admin_customer_editar',['id' => $customer_detail->id]) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Editar </a>
