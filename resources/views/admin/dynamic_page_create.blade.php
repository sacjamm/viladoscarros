...
@section('admin_content')
    ...
    <form action="{{ route('admin_dynamic_page_store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="dynamic_page_name" id="dynamic_page_name" class="form-control dynamic_page_name" value="{{ old('dynamic_page_name') }}" autofocus oninput="generateSlug('dynamic_page_name','dynamic_page_slug')">
                </div>
                <div class="form-group">
                    <label for="">{{ SLUG }}</label>
                    <input type="text" name="dynamic_page_slug" id="dynamic_page_slug" class="form-control dynamic_page_slug" value="{{ old('dynamic_page_slug') }}" readonly>
                </div>
                <div class="form-group">
