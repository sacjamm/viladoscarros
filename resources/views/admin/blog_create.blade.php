        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="post_title" id="post_title" class="form-control post_title" value="{{ old('post_title') }}" autofocus oninput="generateSlug('post_title','post_slug')">
                </div>
                <div class="form-group">
                    <label for="">{{ SLUG }}</label>
                    <input type="text" name="post_slug" class="form-control post_slug" id="post_slug" readonly="" value="{{ old('post_slug') }}">
                </div>
                <div class="form-group">
                    <label for="">{{ CONTENT }} *</label>
<!--                    <textarea name="post_content" class="form-control editor" cols="30" rows="10">{{ old('post_content') }}</textarea>-->
                    <textarea name="content" class="form-control" id="summernote" cols="30" rows="10">{{ old('post_content') }}</textarea>
                </div>
                <div class="form-group">
