        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="listing_location_name" id="listing_location_name" class="form-control listing_location_name" value="{{ old('listing_location_name') }}" autofocus oninput="generateSlug('listing_location_name','listing_location_slug')">
                </div>
                <div class="form-group">
                    <label for="">{{ SLUG }}</label>
                    <input type="text" name="listing_location_slug" id="listing_location_slug" class="form-control listing_location_slug" value="{{ old('listing_location_slug') }}" readonly="">
                </div>
                <div class="form-group">
