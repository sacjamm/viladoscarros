                ...
                <div class="row">
                    <div class="col-md-3 col-sm-12">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" id="p12_tab" data-toggle="pill" href="#p12" role="tab" aria-controls="p12" aria-selected="false">Google Maps</a>
                            <a class="nav-link" id="p13_tab" data-toggle="pill" href="#p13" role="tab" aria-controls="p13" aria-selected="false">Google Tag Manager</a>
                            ...
                            <a class="nav-link" id="p11_tab" data-toggle="pill" href="#p11" role="tab" aria-controls="p11" aria-selected="false">Outras configurações</a>
                        </div>
                    </div>
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="p11" role="tabpanel" aria-labelledby="p11_tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="facebook_access_token" class="form-control" value="{{ $setting->facebook_access_token }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Facebook Catalog ID</label>
                                    <input type="text" name="facebook_catalog_id" class="form-control" value="{{ $setting->facebook_catalog_id }}">
                                </div>
                                <div class="form-group">
                                    <label for="">C2S token</label>
                                    <input type="text" name="c2s_token" class="form-control" value="{{ $setting->c2s_token }}">
                                </div>
                                <!-- // Tab Content -->
                            ...
                            <div class="tab-pane fade" id="p12" role="tabpanel" aria-labelledby="p12_tab">

                                <!-- Tab Content -->
                                <div class="form-group">
                                    <label for="">Sua Chave de API do Google Maps</label>
                                    <input type="text" name="google_maps_api_key" class="form-control" value="{{ $setting->google_maps_api_key }}">
                                </div>

                                <div class="form-group">
                                    <label for="">Status do Google Maps</label>
                                    <select name="google_maps_status" class="form-control">
                                        <option value="Show" {{ $setting->google_maps_status == 'Show' ? 'selected' : '' }}>{{ SHOW }}</option>
                                        <option value="Hide" {{ $setting->google_maps_status == 'Hide' ? 'selected' : '' }}>{{ HIDE }}</option>
                                    </select>
                                </div>
                                <!-- // Tab Content -->
                            ...
                            <div class="tab-pane fade" id="p13" role="tabpanel" aria-labelledby="p13_tab">

                                <!-- Tab Content -->
                                <div class="form-group">
                                    <label for="">Google TAG Manager (ID:: GTM)</label>
                                    <input type='text' name="google_tag_manager_body" class="form-control" value="{{ $setting->google_tag_manager_body }}" />
                                </div>
                                

                                <div class="form-group">
                                    <label for="">Status do Google Tag Manager</label>
                                    <select name="google_tag_manager_status" class="form-control">
                                        <option value="Show" {{ $setting->google_tag_manager_status == 'Show' ? 'selected' : '' }}>{{ SHOW }}</option>
                                        <option value="Hide" {{ $setting->google_tag_manager_status == 'Hide' ? 'selected' : '' }}>{{ HIDE }}</option>
                                    </select>
                                </div>
                                <!-- // Tab Content -->
