        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="category_name" class="form-control category_name" id="category_name" value="{{ $category->category_name }}" autofocus oninput="generateSlug('category_name','category_slug')">
                </div>
                <div class="form-group">
                    <label for="">{{ SLUG }}</label>
                    <input type="text" name="category_slug" id="category_slug" class="form-control category_slug" value="{{ $category->category_slug }}" readonly="">
                </div>
            </div>
            <div class="card-header py-3">
