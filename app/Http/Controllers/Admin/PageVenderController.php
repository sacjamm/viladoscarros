...
class PageVenderController extends Controller
{
    ...
    {
        $page_vender = PageVenderItem::where('id',1)->first();
        return view('admin.page_vender', compact('page_vender'));
    }
    ...
    public function update(Request $request)
    {
       ...
       /* if(env('PROJECT_MODE') == 0) {
        ...
        PageVenderItem::where('id',1)->update($data);
