...
class ListingLocationController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('listing_location_photo')) {
            ...
            $currentLocationPath = public_path('uploads/listing_location_photos/' . $listing_location->listing_location_photo);
            if (file_exists($currentLocationPath)) {
                unlink($currentLocationPath);
            } else {
